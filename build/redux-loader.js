...
exports.START_LOADING = "@redux-loader/start-loading";
exports.COMPLETE_LOADING = "@redux-loader/complete-loading";
var Status;
(function (Status) {
...
var loader_1 = __webpack_require__(35);
...
const initialState = {
    status: constants_1.Status.NONE,
    statusMessage: null
};
function reducer(state = initialState, action) {
    const { type, payload } = action;
    switch (type) {
        case constants_1.START_LOADING:
            return Object.assign({}, state, { status: constants_1.Status.PROGRESS }, payload);
        case constants_1.COMPLETE_LOADING:
...
const mapStateToProps = ({ loader }, ownProps) => (Object.assign({}, loader, ownProps));
const mapDispatchToPropsWrapper = (loadFn) => (dispatch, ownProps) => ({
    loading() {
        ...
        return loadFn(ownProps).then((result) => {
            ...
            dispatch(actions_1.completeLoadingAction({
                status: constants_1.Status.ERROR,
...
exports.loader = (loadFn) => Component => {
    class Loader extends React.Component {
        ...
        render() {
            const _a = this.props, { label = '...', status, statusMessage } = _a, restProps = __rest(_a, ["label", "status", "statusMessage"]);
            const isLoading = status === constants_1.Status.PROGRESS;
            const isCompleted = [constants_1.Status.SUCCESS, constants_1.Status.WARNING, constants_1.Status.ERROR].some(compStatus => compStatus === status);
            const isLoadedSuccessfully = isCompleted && status === constants_1.Status.SUCCESS;
            if (isLoading) {
                return React.createElement("div", { className: 'loader-container' },
                    label && React.createElement("h3", null, label),
                    statusMessage && React.createElement("p", null, statusMessage),
                    React.createElement("i", { className: 'fa fa-spinner text-primary', style: { fontSize: "48px" } }));
            }
            ...
            return React.createElement("p", { className: "text-danger" },
                React.createElement("h3", null, statusMessage));
        }
    }
    return react_redux_1.connect(mapStateToProps, mapDispatchToPropsWrapper(loadFn))(Loader);
};
...
Object.defineProperty(exports, "__esModule", { value: true });
const constants_1 = __webpack_require__(5);
exports.createPayloadAction = (type, payload) => ({
    type: type,
    payload
});
exports.startLoadingAction = (payloadOptions) => exports.createPayloadAction(constants_1.START_LOADING, payloadOptions);
exports.completeLoadingAction = (payloadOptions) => exports.createPayloadAction(constants_1.COMPLETE_LOADING, payloadOptions);
